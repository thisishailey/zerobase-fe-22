...
export default function MenuPanel({ onClick }: { onClick: () => void }) {
    return (
        <>
            <div className="absolute top-[1vh] left-[1vh] flex flex-col justify-between w-[35vw] max-w-sm h-[98vh] rounded-xl bg-zinc-500/95 dark:bg-zinc-800/95 text-neutral-50 dark:text-neutral-300 hidden menu-side-panel">
